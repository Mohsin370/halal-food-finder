...
namespace backend.Services
{
    public class GooglePlaceService: IGooglePlacesService
    {
        ...
        public async Task<string> PlaceDetails(string placeId, string fieldMask)
        {
            //var encodedInput = HttpUtility.UrlEncode(placeId);
            var endpoint = $"{placesEndPoint}/{placeId}";
